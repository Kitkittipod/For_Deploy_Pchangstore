...
export default function Dashboard() {
  ...
  useEffect(() => {
    fetch('https://pstore-backendd.vercel.app/getTodaySales')
      .then((res) => res.json())
      .then((data) => setTodaySales(data));
    fetch('https://pstore-backendd.vercel.app/getBestSellingMenu')
      .then((res) => res.json())
      .then((data) => setBestSelling(data));
    fetch('https://pstore-backendd.vercel.app/getIngredientsUsed')
      .then((res) => res.json())
